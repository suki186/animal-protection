...
<p align="center">
  <img src="https://github.com/user-attachments/assets/245495f1-8642-40cf-8834-cccffe5eac32" alt="image"/>

</p>
- 배포 URL : https://group-project-green-six.vercel.app/ <br/>
- OpenAPI: https://www.data.go.kr/tcs/dss/selectApiDataDetailView.do?publicDataPk=15098931 <br/>
...
## 👨‍💻 팀원 소개
- 박승원(PO) - 동물카드, 메인 Carousel, 동물페이지(검색, 필터링), NotFound페이지, 입양정보페이지.
- 김희진(SM) - 로그인페이지, 로그인 관리, 찜하기 기능.
- 김서희 - 초기파일 및 라우터 세팅, 메인 Banner, 동물상세페이지, Footer, Aside, ScrollTop 기능.
- 김승현 - 로고 제작, 네비게이션 바, 입양안내페이지, 전체적인 CSS.
- 이제의 - 보호소 지도리스트, 지도에 보호소 마커, 보호소상세페이지.
